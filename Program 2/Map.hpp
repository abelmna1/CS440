...
/****************************************************************************/
    ...
    /*template<typename Key_T, typename Mapped_T>
    bool operator==(const typename Map<Key_T, Mapped_T>::Iterator &I1, const typename Map<Key_T, Mapped_T>::Iterator &I2){
        if(I1.getNodePtr() == NULL || I2.getNodePtr() == NULL) return false;
		else if(I1.getNodePtr() == I2.getNodePtr())	 return true;
		else return false;
    }
    ...
    template<typename Key_T, typename Mapped_T>
    bool operator==(const typename Map<Key_T, Mapped_T>::ConstIterator &I1, const typename Map<Key_T, Mapped_T>::ConstIterator &I2){
        if(I1.getConstNodePtr() == NULL || I2.getConstNodePtr() == NULL) return false;
		else if(I1.getConstNodePtr() == I2.getConstNodePtr())	 return true;
		else return false;
    ...
    template<typename Key_T, typename Mapped_T>
    bool operator==(const typename Map<Key_T, Mapped_T>::Iterator &I1, const typename Map<Key_T, Mapped_T>::ConstIterator &I2){
        if(I1.getNodePtr() == NULL || I2.getConstNodePtr() == NULL) return false;
		else if(I1.getNodePtr() == I2.getConstNodePtr())	 return true;
		else return false;
	}
    ...
    template<typename Key_T, typename Mapped_T>
    bool operator==(const typename Map<Key_T, Mapped_T>::ConstIterator &I1, const typename Map<Key_T, Mapped_T>::Iterator &I2){
        if(I1.getConstNodePtr() == NULL || I2.getNodePtr() == NULL) return false;
		else if(I1.getConstNodePtr() == I2.getNodePtr()) return true;
		else return false;
	}
    ...
    //last 2 might be unneccesary
    template<typename Key_T, typename Mapped_T>
    bool operator==(const typename Map<Key_T, Mapped_T>::ReverseIterator &I1, const typename Map<Key_T, Mapped_T>::ReverseIterator &I2){
		if(I1.getReverseNodePtr() == NULL || I2.getReverseNodePtr() == NULL) return false;
		else if(I1.getReverseNodePtr() == I2.getReverseNodePtr()) return true;
		else return false;
    }
    ...
    bool operator==(const Map<Key_T, Mapped_T> &m1, const Map<Key_T, Mapped_T> &m2){
    	if(m1.size() == m2.size()){
			if(m1.size() == 0) return true;
			typename Map<Key_T, Mapped_T>::Iterator iter1 = m1.begin();
			typename Map<Key_T, Mapped_T>::Iterator iter2 = m2.begin();
			for(; iter1 != m1.end(); ++iter1, ++iter2){
				SkipNode<Key_T, Mapped_T>* temp1 = (static_cast<SkipNode<Key_T, Mapped_T>*>( iter1->getNodePtr() ) );
				SkipNode<Key_T, Mapped_T>* temp2 = (static_cast<SkipNode<Key_T, Mapped_T>*>( iter2->getNodePtr() ) );
				if(temp1->nodePair != temp2->nodePair) return false;
			}
			return true;
		}
    ...
    bool operator<(const Map<Key_T, Mapped_T> &m1, const Map<Key_T, Mapped_T> &m2){
		...
		typename Map<Key_T, Mapped_T>::Iterator iter1 = m1.begin();
    	typename Map<Key_T, Mapped_T>::Iterator iter2 = m2.begin();
		if(iter1.getNodePtr() == NULL && iter2.getNodePtr() != NULL) return true;
		else if(iter1.getNodePtr() != NULL && iter2.getNodePtr() == NULL) return false;
		else if(iter1.getNodePtr() == NULL && iter2.getNodePtr() == NULL) return false;
		else{
			if(m1.size() < m2.size()){
				for(; iter1 != m1.end(); ++iter1){
					SkipNode<Key_T, Mapped_T>* temp1 = (static_cast<SkipNode<Key_T, Mapped_T>*>( iter1->getNodePtr() ) );
					SkipNode<Key_T, Mapped_T>* temp2 = (static_cast<SkipNode<Key_T, Mapped_T>*>( iter2->getNodePtr() ) );
					if(temp1->nodePair < temp2->nodePair) return true;
					else if(temp1->nodePair > temp2->nodePair) return false;
